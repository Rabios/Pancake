...
p.g.fit = function() {
    ...
    if (ctx2d_enabled) {
        ...
        p.g.ctx2d.canvas.width = p.can.compatible_width + 20;
        p.g.ctx2d.canvas.height = p.can.compatible_height + 20;
    }
};
...
p.g.toggleFullscreen = function() {
    ...
    if (q.mozRequestFullScreen) q.mozRequestFullScreen();
    if (q.webkitRequestFullscreen) q.webkitRequestFullscreen();
    if (q.webkitRequestFullScreen) q.webkitRequestFullScreen();
    if (q.msRequestFullscreen) q.msRequestFullscreen();
};
...
p.g.gradientRect = po.c.gradientRect;
p.g.text = po.c.text;
